...
public class ParticleEntity : MonoBehaviour
{
    ...
    //Modifiers
    [SerializeField]private ParticleEntityData entityData;
    ...
    [SerializeField]public UltEvents.UltEvent<ParticleEntity> _OnDeathEvent;
    public void Death(){
        ...
        if(entityData.deathParticlesPrefab != null){
            ...
            if(entityData.particlesMatchColor){
                ...
                main.startColor = g;
                //JMath.AverageColor(spriteRenderer.sprite);
            }
        }
